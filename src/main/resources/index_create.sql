CREATE INDEX IF NOT EXISTS launch_project_idx
    ON launch (project_id);
CREATE INDEX IF NOT EXISTS launch_user_idx
    ON launch (user_id);
...
CREATE INDEX IF NOT EXISTS item_attr_ti_idx
...
CREATE INDEX IF NOT EXISTS statistics_ti_idx
...
CREATE INDEX IF NOT EXISTS issue_it_idx
    ON issue (issue_type);
CREATE INDEX IF NOT EXISTS ticket_submitter_idx
    ON ticket (submitter);
...
ALTER TABLE pattern_template_test_item
    SET (AUTOVACUUM_ENABLED = TRUE);
